package ru.citeck.ecos.uiserv.app.cache.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("uiserv_hazelcast");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("uiserv_hazelcast");
        ...
        config.getMapConfigs().put("ru.citeck.ecos.uiserv.domain.*", initializeDomainMapConfig(jHipsterProperties));
