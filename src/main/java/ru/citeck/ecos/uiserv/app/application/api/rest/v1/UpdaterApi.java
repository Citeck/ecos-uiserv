package ru.citeck.ecos.uiserv.app.application.api.rest.v1;
...
import ru.citeck.ecos.uiserv.app.application.api.rest.v1.dto.ModuleToDeploy;
import ru.citeck.ecos.uiserv.domain.file.repo.File;
import ru.citeck.ecos.uiserv.domain.file.repo.FileType;
import ru.citeck.ecos.uiserv.domain.file.service.FileBundle;
...
public class UpdaterApi {
    ...
    private static final String MIME_TYPE_LOWERCASE = "application/zip";
