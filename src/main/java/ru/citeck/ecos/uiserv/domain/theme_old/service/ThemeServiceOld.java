package ru.citeck.ecos.uiserv.domain.theme_old.service;
...
import ru.citeck.ecos.uiserv.domain.theme_old.repo.UserTheme;
import ru.citeck.ecos.uiserv.domain.theme_old.repo.UserThemeRepository;
import ru.citeck.ecos.uiserv.domain.file.service.FileService;

@Service
@RequiredArgsConstructor
@Transactional
public class ThemeServiceOld {
