...
class BoardCardOrderServiceMoveTest {
    ...
    fun `first move in a column materializes the whole column`() = AuthContext.runAsSystem {
        ...
        service.moveCard(MoveCardAction(fixture.boardRef, fixture.card("c1"), "col1", afterCard = null))
    ...
    fun `move within column places card right after the anchor`() = AuthContext.runAsSystem {
        ...
        service.moveCard(MoveCardAction(fixture.boardRef, fixture.card("c2"), "col1", afterCard = fixture.card("c1")))
    ...
    fun `move between columns changes _status and positions in target`() = AuthContext.runAsSystem {
        service.moveCard(MoveCardAction(fixture.boardRef, fixture.card("c2"), "col2", afterCard = null))
    ...
    fun `new card after moves appears on top, next move folds it in`() = AuthContext.runAsSystem {
        ...
        service.moveCard(MoveCardAction(fixture.boardRef, fixture.card("c3"), "col1", afterCard = fixture.card("c2")))
    ...
    fun `move under a grouping inherits flat baseline and leaves flat order untouched`() = AuthContext.runAsSystem {
        ...
        service.moveCard(
            MoveCardAction(fixture.boardRef, fixture.card("c3"), "col1", afterCard = null, grouping = "assignee")
        )
    ...
    fun `order is isolated per workspace`() = AuthContext.runAsSystem {
        ...
        service.moveCard(
            MoveCardAction(fixture.boardRef, fixture.card("c1"), "col1", afterCard = null),
            workspace = "wsA"
        )
