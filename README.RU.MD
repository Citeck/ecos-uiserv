...
Добро пожаловать в репозиторий Citeck `ecos-uiserv`! В репозитоии хранятся конфигурации платформы Citeck — системы для автоматизации бизнес-процессов и управления корпоративными данными.
